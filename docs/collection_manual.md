...
### D03 `bed_exit_fall` - 침대에서 일어나려다 낙상
...
- 종료 자세: 침대 옆 매트 측와위
- 허용 variant: bed_exit_fall_left, bed_exit_fall_right
...
- 금지 행동: 완전히 일어난 뒤 걷기, 침대에서 굴러 떨어지기, 머리부터 떨어지기, 침대 또는 벽을 잡기
- 재수집 기준: 일어나려는 시도 없이 바로 바닥으로 내려감, 매트 밖 접촉, 머리 또는 손목 충격, 안전요원 접촉
...
### D05 `chair_exit_fall` - 의자에서 일어나려다 낙상
...
- 종료 자세: 의자 옆 매트 측와위
- 허용 variant: chair_exit_fall_left, chair_exit_fall_right
...
- 금지 행동: 의자 전도, 완전히 선 뒤 걷기, 머리 또는 손목 첫 접촉, 매트 밖 착지
- 재수집 기준: 일어서기 시도 없이 옆으로 미끄러짐, 의자가 2 cm 이상 움직임, 안전요원 접촉, 매트 밖 착지
